...
import static com.makhalibagas.searchgithub.Database.DatabaseContract.getColumnInt;
import static com.makhalibagas.searchgithub.Database.DatabaseContract.getColumnString;
...
public class Useritem implements Parcelable {
    ...
    public Useritem(Cursor cursor) {
        ...
        this.login = getColumnString(cursor, USERNAME);
        this.avatarUrl = getColumnString(cursor, AVATAR);
        this.url = getColumnString(cursor, URL);
    }
